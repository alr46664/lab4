...
set_input_delay -add_delay  -clock [get_clocks {clk}]  35.000 [get_ports {we*}]
...
set_input_delay -add_delay  -clock [get_clocks {clk}]  35.000 [get_ports {reg_addr_in*}]
...
set_output_delay -add_delay -clock { clk } 35.000 [get_ports reg_data_out*]
set_output_delay -add_delay -clock { clk } 35.000 [get_ports reg_addr_out*]
